(function() {
    ...
    function mandatoryParent(parentCheckBoxIdSubstring, childCheckBoxIdSubstring, disabledChildrenIdSubstring, disabledParentIdSubstring) {
        var params = {};
        ...
        if (disabledParentIdSubstring) params.disabledParent = getCheckboxesByIdContaining(disabledParentIdSubstring)[0];
    ...
    $('.account-documents-grid tbody tr').on('mouseenter', function() {
